"""Upsert normalized water-heater points using Qdrant Cloud Inference."""
...
def load_products() -> list[dict]:
    ...
    if not isinstance(products, list) or not products:
        raise ValueError("Không có dữ liệu máy nước nóng đã chuẩn hóa để upload")
    return products


def point_generator(products: list[dict]) -> Iterator[models.PointStruct]:
    """Yield stable points and let Qdrant Cloud embed semantic passage text."""
