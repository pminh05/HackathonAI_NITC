...
def load_products() -> list[dict]:
    ...
    if not isinstance(products, list) or not products:
        raise ValueError("Không có dữ liệu máy giặt đã chuẩn hóa để upload")
    return products


def point_generator(products: list[dict]):
    """Yield deterministic points and let Qdrant Cloud embed their passage text."""
